(function () {
    ...
    function LeasingFormController($timeout, constants, applicationContext,
        ...
        ctrl.fee = minimumFee;
        ctrl.availableBalance = Money.fromCoins(0, Currency.TN);

        ctrl.broadcast = new transactionBroadcast.instance(apiService.leasing.lease,
            function (transaction) {
                var amount = Money.fromCoins(transaction.amount, Currency.TN);
        ...
        function reset() {
            ctrl.amount = '0';
            ctrl.recipient = '';
            ctrl.confirm.amount = Money.fromTokens(0, Currency.TN);
